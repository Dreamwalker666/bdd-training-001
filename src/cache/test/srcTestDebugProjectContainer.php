...
class srcTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_c64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049' => 'get1C64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049Service',
            '2_c64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049' => 'get2C64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049Service',
            'acme.bank_account_factory' => 'getAcme_BankAccountFactoryService',
            'acme.controller' => 'getAcme_ControllerService',
            'acme.repository.current_account' => 'getAcme_Repository_CurrentAccountService',
            'acme.repository.premium_account' => 'getAcme_Repository_PremiumAccountService',
        ...
        $this->privates = array(
            '1_c64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049' => true,
            '2_c64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049' => true,
    ...
    /**
     * Gets the public 'acme.bank_account_factory' shared service.
     *
     * @return \App\BankAccountFactory
     */
    protected function getAcme_BankAccountFactoryService()
    {
        return $this->services['acme.bank_account_factory'] = new \App\BankAccountFactory(${($_ = isset($this->services['acme.repository.premium_account']) ? $this->services['acme.repository.premium_account'] : $this->get('acme.repository.premium_account')) && false ?: '_'}, ${($_ = isset($this->services['acme.repository.current_account']) ? $this->services['acme.repository.current_account'] : $this->get('acme.repository.current_account')) && false ?: '_'});
    }

    /**
     * Gets the public 'acme.controller' shared service.
     *
     * @return \App\Controller
     */
    protected function getAcme_ControllerService()
    {
        return $this->services['acme.controller'] = new \App\Controller(${($_ = isset($this->services['acme.bank_account_factory']) ? $this->services['acme.bank_account_factory'] : $this->get('acme.bank_account_factory')) && false ?: '_'});
    }

    /**
     * Gets the public 'acme.repository.current_account' shared service.
     *
     * @return \Acme\Account\FileBasedAccountRepository
     */
    protected function getAcme_Repository_CurrentAccountService()
    {
        return $this->services['acme.repository.current_account'] = new \Acme\Account\FileBasedAccountRepository('current_account');
    }

    /**
     * Gets the public 'acme.repository.premium_account' shared service.
     *
     * @return \Acme\Account\FileBasedAccountRepository
     */
    protected function getAcme_Repository_PremiumAccountService()
    {
        return $this->services['acme.repository.premium_account'] = new \Acme\Account\FileBasedAccountRepository('premium_account');
    }
    ...
    {
        return $this->services['cache.app'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('6CZ3B8uKes', 0, (__DIR__.'/pools'));
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fF7hwh+IDJ', 0, 'SXbaJNMeZyIT-9OJLwLB1k', (__DIR__.'/pools'), NULL);
    }
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_c64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049']) ? $this->services['1_c64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049'] : $this->get1C64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_c64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049']) ? $this->services['2_c64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049'] : $this->get2C64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        })), new \Symfony\Component\Translation\MessageSelector(), 'en', array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('my-secret');
    }
    ...
    /**
     * Gets the private '1_c64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1C64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049Service()
    {
        return $this->services['1_c64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_c64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2C64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049Service()
    {
        return $this->services['2_c64c4bab00b80c8f329fe398a2772b20e06e3cda356d458a436d37ec5081b049'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vYM7sq+hXV', 0, 'SXbaJNMeZyIT-9OJLwLB1k', (__DIR__.'/pools'), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'debug.container.dump' => (__DIR__.'/srcTestDebugProjectContainer.xml'),
